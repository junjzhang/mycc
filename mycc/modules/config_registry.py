...
class ConfigRegistry:
    ...
    def _validate_config_data(self, name: str, config_data: Dict[str, Any]) -> None:
        ...
        if missing_fields:
            raise ConfigValidationError(
                f"Configuration '{name}' missing required fields: {missing_fields}"
            )
        ...
        if config_data.get('relative_to_home') and config_data.get('relative_to_config'):
            raise ConfigValidationError(f"Configuration '{name}' cannot be both relative_to_home and relative_to_config")
    ...
    def get_entries_by_type(self, relative_to_home: Optional[bool] = None, 
                           relative_to_config: Optional[bool] = None) -> Dict[str, ConfigEntry]:
