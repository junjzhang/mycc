...
class TestConfigRegistry:
    ...
    def test_registry_basic_operations(self):
        ...
        entry = ConfigEntry(name="test", source_path="src.json", target_path="target.json")
...
class TestConfigsModule:
    ...
    def create_configs_module(self):
        ...
        configs = ConfigsModule(
            project_root=self.project_root, target_root=self.claude_dir, test_mode=True, home_dir=self.home_dir
        )
    ...
    def test_get_files(self):
        ...
        expected_files = ["claude/settings.json", "ccstatusline/settings.json", "tweakcc/config.json"]
